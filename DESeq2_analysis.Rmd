...
```{r}
getwd()
#setwd("C:/Users/dibin/Downloads/")  # to have all results at this path
...
raw_counts <- read.csv("C:/Users/dibin/Downloads/GSE106305_counts_matrix1.csv", header = TRUE, row.names = "Geneid", stringsAsFactors = FALSE)
head(raw_counts)
...
```{r}
library(data.table)
annotation_file <- "C:/Users/dibin/Downloads/GRCh38annotation.csv"
annotation <- fread(annotation_file, stringsAsFactors = FALSE)
counts_gse <- read.csv("C:/Users/dibin/Downloads/GSE106305_counts_matrix1.csv",
                     header = TRUE,
...
png("C:/Users/dibin/Downloads/de_gene_heatmap.png",
